...
All PRs must maintain 100% test suite compliance (**519 / 519 tests collected** across `tests/` and `backend/tests`). Never break existing test assertions or compromise the **Determinism Invariant**.
