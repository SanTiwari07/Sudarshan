    ...
    <FindingDrawerShell
      ...
      headerExtra={
        <div className="flex flex-wrap items-center gap-2 mt-2">
          <span className={`text-[12px] font-bold uppercase px-2 py-0.5 rounded border ${sevClass}`}>
            {vm.severityLabel}
          </span>
    ...
    >
      ...
      <FindingSection label="Evidence basis">
        <div className="flex flex-wrap items-center gap-2 mb-2">
          <span className="text-[12px] font-bold uppercase px-2 py-0.5 rounded border border-slate-300 bg-white text-slate-700">
