...
| [**11 - Evaluation Strategy**](evaluation/11_EVALUATION.md) | Verification & Testing | Automated test suite in `tests/` & `backend/tests/` (**923 collected tests** as of 2026-08-15), benchmarks, determinism baselines. |
...
| [**VALIDATION.md**](VALIDATION.md) | Validation Protocols | Determinism replay, ground-truth matrix, pytest suite (**923**), dynamic APK corpus (`validate_dynamic_pipeline.py`). |
...
- **Verification Metric**: **923 tests collected** (verified 2026-08-15; 3 errors are infrastructure-dependent tests requiring live sandbox or network).
