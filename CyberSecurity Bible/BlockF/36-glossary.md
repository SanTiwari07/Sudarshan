...
**MobSF** — Open-source mobile security framework. Measures **security hygiene, not maliciousness**
— its score must not be read as a malware verdict. → [Ch 11 §8](../static-analysis/11-static-analysis.md#8-mobsf)
