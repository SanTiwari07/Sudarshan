...
- Boundaries you will hit: [`KNOWN_LIMITATIONS.md`](../05_SECURITY/KNOWN_SECURITY_LIMITATIONS.md)
...
Never commit `.env`. Demo account configuration: [`BOI_DEMO_CREDENTIALS.md`](../00_PROJECT/GROUND_TRUTH.md).
...
Requires `JWT_SECRET_KEY`, `ANALYSIS_ENGINE_INTERNAL_TOKEN`, and a containment-compliant ADB route. Startup validation aborts on a non-compliant configuration. Background: [`../05_SECURITY/THREAT_MODEL.md`](../05_SECURITY/THREAT_MODEL.md).
...
See [`VALIDATION.md`](../10_VALIDATION/VALIDATION.md) and [`../../tests/README.md`](../../tests/README.md).
