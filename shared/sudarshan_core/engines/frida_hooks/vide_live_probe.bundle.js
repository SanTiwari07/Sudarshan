...
frida_java_bridge_default.perform(function() {
  var WebView = frida_java_bridge_default.use("android.webkit.WebView");
  ...
  setTimeout(function() {
    frida_java_bridge_default.scheduleOnMainThread(function() {
      try {
        var AT = frida_java_bridge_default.use("android.app.ActivityThread");
